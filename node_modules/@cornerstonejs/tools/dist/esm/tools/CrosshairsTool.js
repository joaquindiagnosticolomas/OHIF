    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.renderAnnotation = (enabledElement, svgDrawingHelper) => {
            ...
            otherViewportAnnotations.forEach((annotation) => {
                ...
                vec2.scale(canvasVectorFromCenterMid, canvasUnitVectorFromCenter, canvasDiagonalLength * 0.25);
                const canvasVectorFromCenterShort = vec2.create();
                vec2.scale(canvasVectorFromCenterShort, canvasUnitVectorFromCenter, canvasDiagonalLength * 0.15);
                const canvasVectorFromCenterStart = vec2.create();
                vec2.scale(canvasVectorFromCenterStart, canvasUnitVectorFromCenter, otherViewportAnnotations.length === 2 ? canvasDiagonalLength * 0.04 : 0);
