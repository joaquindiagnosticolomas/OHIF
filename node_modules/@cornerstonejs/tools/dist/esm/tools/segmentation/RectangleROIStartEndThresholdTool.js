...
class RectangleROIStartEndThresholdTool extends RectangleROITool {
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.addNewAnnotation = (evt) => {
            ...
            if (viewport instanceof StackViewport) {
                ...
                referencedImageId = csUtils.getClosestImageId(imageVolume, worldPos, viewPlaneNormal, viewUp);
            }
    ...
    _computeProjectionPoints(annotation, imageVolume) {
        ...
        for (const RectanglePoints of newProjectionPoints) {
            const imageId = csUtils.getClosestImageId(imageVolume, RectanglePoints[0], viewPlaneNormal, metadata.viewUp);
