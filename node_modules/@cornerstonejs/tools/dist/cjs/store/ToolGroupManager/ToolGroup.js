...
class ToolGroup {
    ...
    setToolPassive(toolName) {
        ...
        toolOptions.bindings = toolOptions.bindings.filter((binding) => binding.mouseButton !== enums_1.MouseBindings.Primary || binding.modifierKey);
        let mode = Passive;
    ...
    _hasMousePrimaryButtonBinding(toolOptions) {
        var _a;
        return (_a = toolOptions === null || toolOptions === void 0 ? void 0 : toolOptions.bindings) === null || _a === void 0 ? void 0 : _a.some((binding) => binding.mouseButton === enums_1.MouseBindings.Primary &&
