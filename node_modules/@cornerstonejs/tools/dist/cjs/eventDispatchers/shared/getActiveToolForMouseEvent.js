...
function getActiveToolForMouseEvent(evt) {
    ...
    const modifierKey = eventListeners_1.keyEventListener.getModifierKey() || (0, getMouseModifier_1.default)(mouseEvent);
        ...
        const correctBinding = toolOptions.bindings.length &&
            toolOptions.bindings.some((binding) => {
                return (binding.mouseButton ===
                    (mouseEvent ? mouseEvent.buttons : enums_1.MouseBindings.Primary) &&
