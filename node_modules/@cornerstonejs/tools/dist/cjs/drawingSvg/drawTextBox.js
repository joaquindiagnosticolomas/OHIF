...
function _drawTextGroup(svgDrawingHelper, annotationUID, textUID, textLines = [''], position, options) {
    ...
    if (existingTextGroup) {
        ...
        (0, _setAttributesIfNecessary_1.default)(textAttributes, textElement);
        (0, _setAttributesIfNecessary_1.default)(textGroupAttributes, existingTextGroup);
...
function _drawTextBackground(group, color) {
    ...
    (0, _setAttributesIfNecessary_1.default)(attributes, element);
    return bBox;
}
