...
class ProbeTool extends base_1.AnnotationTool {
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.renderAnnotation = (enabledElement, svgDrawingHelper) => {
            ...
            for (let i = 0; i < annotations.length; i++) {
                ...
                renderStatus = true;
                const isPreScaled = (0, isViewportPreScaled_1.isViewportPreScaled)(viewport, targetId);
    ...
    _getTextLines(data, targetId, isPreScaled) {
        ...
        const textLines = [];
        const unit = (0, getModalityUnit_1.getModalityUnit)(Modality, isPreScaled);
    ...
    _calculateCachedStats(annotation, renderingEngine, enabledElement) {
        ...
        for (let i = 0; i < targetIds.length; i++) {
            ...
            if (core_1.utilities.indexWithinDimensions(index, dimensions)) {
                ...
                cachedStats[targetId] = Object.assign(Object.assign({ index }, values), { Modality: modality });
            }
            else {
