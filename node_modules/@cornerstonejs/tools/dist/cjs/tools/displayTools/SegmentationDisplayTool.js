        ...
        this.renderSegmentation = (toolGroupId) => {
            ...
            const segmentationRenderList = toolGroupSegmentationRepresentations.map((representation) => {
                ...
                for (const viewport of toolGroupViewports) {
                    ...
                    else if (representation.type == SegmentationRepresentations_1.default.Contour) {
                        viewportsRenderList.push(Contour_1.contourDisplay.render(viewport, representation, config));
                    }
                }
