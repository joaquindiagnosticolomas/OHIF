    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.renderAnnotation = (enabledElement, svgDrawingHelper) => {
            ...
            otherViewportAnnotations.forEach((annotation) => {
                ...
                gl_matrix_1.vec2.scale(canvasVectorFromCenterMid, canvasUnitVectorFromCenter, canvasDiagonalLength * 0.25);
                const canvasVectorFromCenterShort = gl_matrix_1.vec2.create();
                gl_matrix_1.vec2.scale(canvasVectorFromCenterShort, canvasUnitVectorFromCenter, canvasDiagonalLength * 0.15);
                const canvasVectorFromCenterStart = gl_matrix_1.vec2.create();
                gl_matrix_1.vec2.scale(canvasVectorFromCenterStart, canvasUnitVectorFromCenter, otherViewportAnnotations.length === 2 ? canvasDiagonalLength * 0.04 : 0);
