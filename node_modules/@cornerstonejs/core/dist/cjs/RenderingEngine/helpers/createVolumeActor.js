...
function createVolumeActor(props, element, viewportId, suppressEvents = false, use16BitTexture = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (imageVolume.imageIds) {
            yield (0, setDefaultVolumeVOI_1.default)(volumeActor, imageVolume, use16BitTexture);
        }
        if (callback) {
