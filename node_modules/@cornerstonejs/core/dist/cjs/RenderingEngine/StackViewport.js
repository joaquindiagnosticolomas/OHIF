...
const InterpolationType_1 = __importDefault(require("../enums/InterpolationType"));
const VOILUTFunctionType_1 = __importDefault(require("../enums/VOILUTFunctionType"));
...
const isRgbaSourceRgbDest_1 = __importDefault(require("./helpers/isRgbaSourceRgbDest"));
...
class StackViewport extends Viewport_1.default {
    ...
    setStack(imageIds, currentImageIdIndex = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, utilities_1.triggerEvent)(eventTarget_1.default, Events_1.default.STACK_VIEWPORT_NEW_STACK, eventDetail);
            return imageId;
        });
    }
    ...
    _updateVTKImageDataFromCornerstoneImage(image) {
        ...
        if (image.rgba || (0, isRgbaSourceRgbDest_1.default)(pixelData, scalarData)) {
            if (!image.rgba) {
        ...
        return new Promise((resolve, reject) => {
            ...
            function errorCallback(error, imageIdIndex, imageId) {
                ...
                if (!this.suppressEvents) {
                    (0, utilities_1.triggerEvent)(eventTarget_1.default, Events_1.default.IMAGE_LOAD_ERROR, eventDetail);
                }
                reject(error);
            }
            ...
            const priority = -5;
            const requestType = RequestType_1.default.Interaction;
    ...
    _loadAndDisplayImageGPU(imageId, imageIdIndex) {
        return new Promise((resolve, reject) => {
            ...
            (0, utilities_1.triggerEvent)(this.element, Events_1.default.PRE_STACK_NEW_IMAGE, eventDetail);
            imageLoadPoolManager_1.default.addRequest(sendRequest.bind(this, imageId, imageIdIndex, options), requestType, additionalDetails, priority);
        });
    }
    ...
    scroll(delta, debounce = true, loop = false) {
        ...
        if (newTargetImageIdIndex !== currentTargetImageIdIndex) {
            (0, utilities_1.triggerEvent)(this.element, Events_1.default.STACK_VIEWPORT_SCROLL, eventData);
        }
    }
    ...
    triggerCalibrationEvent() {
        ...
        if (!this.suppressEvents) {
            (0, utilities_1.triggerEvent)(this.element, Events_1.default.IMAGE_SPACING_CALIBRATED, eventDetail);
        }
        this._publishCalibratedEvent = false;
    }
