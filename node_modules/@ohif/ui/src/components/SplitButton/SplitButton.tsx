...
const baseClasses = {
  Button:
    'flex items-center rounded border-transparent cursor-pointer group/button',
  Primary:
    ...
    'rounded-tl-md rounded-bl-md group/primary',
  Secondary:
    'h-5 flex items-center justify-center rounded-tr-md rounded-br-md <border-0></border-0> border-transparent group/secondary',
  SecondaryIcon: 'w-4',
  Separator: '',
  Content: 'absolute z-10 top-[-20px] mt-12 left-[-30px]',
};
      ...
      primary.isActive
        ? isExpanded
          ...
          : `${primary.isToggle
            ...
            rounded` // Full, rounded border with less right padding when active.
    ...
    return (
      <div
        className={classNames(
          'flex flex-row items-center p-1 h-5 w-full hover:bg-primary-dark',
